pipeline {
			...
			stages {
				...
				stage('Build') {
    					steps {
    					    sh "'C:\\Program Files (x86)\\MSBuild\\15.0\\FileTracker\\FileTracker64.dll' WebHoly/WebHoly.sln /noautorsp /ds /nologo /t:clean,rebuild /p:Configuration=Debug /v:m /p:VisualStudioVersion=14.0 /clp:Summary;ErrorsOnly;WarningsOnly "

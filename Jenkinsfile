pipeline {
			...
			stages {
				...
				stage('Build') {
    					steps {
    					    sh ""\"${tool 'MSBuild'}\" WebHoly/WebHoly.sln /noautorsp /ds /nologo /t:clean,rebuild /p:Configuration=Debug /v:m /p:VisualStudioVersion=14.0 /clp:Summary;ErrorsOnly;WarningsOnly "
